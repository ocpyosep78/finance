<div class="box box-color box-bordered">
	...
	<div class="box-content nopadding">
		<table id="dg" class="easyui-datagrid" 
				...
				<thead>
					<tr>
						<th data-options="field:'doc_number',width:120" sortable="true">เอกสารเลขที่</th>
						...
						<th data-options="field:'costs',width:100" sortable="true">ประเภทงบ</th>
						<th data-options="field:'coststype',width:100" sortable="true">ประเภทรายจ่าย</th>
						<th data-options="field:'costslists',width:350" sortable="true">รายการจ่าย</th>
						<th data-options="field:'amount',width:120,align:'right'" formatter="formatCurrency" sortable="true">จำนวนเงิน</th>
						<th data-options="field:'status',width:130,align:'center'" sortable="true" formatter="formatStatus">สถานะ</th>
...
<div id="dlg" class="easyui-dialog" style="width:740px;height:600px"  
				     	...
				     	<tbody>
				     	  <tr>
				      	     <td colspan="2">
				      	     	  ...
				      	     	  <input type="text" name="subject" style="font-size: 12px;width:365px;">
					       ...
					       <tr>
				     		...
				     		<tr>
				     			...
				     			<td>
				     			   <label class="control-label" style="width: 100px;">ยอดอนุมัติสะสม</label>
